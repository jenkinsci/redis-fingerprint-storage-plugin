...
link:https://github.com/jenkinsci/jenkins/releases/tag/jenkins-2.248[Jenkins-2.248].
...
link:https://github.com/jenkinsci/jenkins/releases/tag/jenkins-2.251[Jenkins-2.251] introduced fingerprint migration.
